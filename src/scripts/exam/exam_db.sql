...
insert into question (set_question_id, name, order_qn) values (8, '', 8);
insert into question (set_question_id, name, order_qn) values (9, '', 9);
insert into question (set_question_id, name, order_qn) values (10, '', 10);
insert into question (set_question_id, name, order_qn) values (11, '', 11);
insert into question (set_question_id, name, order_qn) values (12, '', 12);
insert into question (set_question_id, name, order_qn) values (13, '', 13);
insert into question (set_question_id, name, order_qn) values (14, '', 14);
insert into question (set_question_id, name, order_qn) values (15, '', 15);
insert into question (set_question_id, name, order_qn) values (16, '', 16);
insert into question (set_question_id, name, order_qn) values (17, '', 17);
insert into question (set_question_id, name, order_qn) values (18, '', 18);
insert into question (set_question_id, name, order_qn) values (19, '', 19);
insert into question (set_question_id, name, order_qn) values (20, '', 20);
insert into question (set_question_id, name, order_qn) values (21, '', 21);
insert into question (set_question_id, name, order_qn) values (22, '', 22);
insert into question (set_question_id, name, order_qn) values (23, '', 23);
insert into question (set_question_id, name, order_qn) values (24, '', 24);
insert into question (set_question_id, name, order_qn) values (25, '', 25);
insert into question (set_question_id, name, order_qn) values (26, '', 26);
insert into question (set_question_id, name, order_qn) values (27, '', 27);
insert into question (set_question_id, name, order_qn) values (28, '', 28);
insert into question (set_question_id, name, order_qn) values (29, '', 29);
insert into question (set_question_id, name, order_qn) values (30, '', 30);
insert into question (set_question_id, name, order_qn) values (31, '', 31);

-- Part 3
insert into question (set_question_id, name, order_qn) values (32, 'What is the woman preparing for?', 32);
insert into question (set_question_id, name, order_qn) values (32, 'Who most likely is the man?', 33);
insert into question (set_question_id, name, order_qn) values (32, 'What does the woman want to pick up on Friday morning?', 34);
insert into question (set_question_id, name, order_qn) values (33, 'What task is the man responsible for?', 35);
insert into question (set_question_id, name, order_qn) values (33, 'What does the woman want to do next year?', 36);
insert into question (set_question_id, name, order_qn) values (33, 'What does the man ask the woman to do?', 37);
insert into question (set_question_id, name, order_qn) values (34, 'What does the woman need a suit for?', 38);
insert into question (set_question_id, name, order_qn) values (34, 'What does the woman dislike about a suit on a display?', 39);
insert into question (set_question_id, name, order_qn) values (34, 'What does the man say that the price includes?', 40);
insert into question (set_question_id, name, order_qn) values (35, 'What kind of a business does the man most likely work for?', 41);
insert into question (set_question_id, name, order_qn) values (35, 'What does the woman say she is concerned about?', 42);
insert into question (set_question_id, name, order_qn) values (35, 'What does the woman agree to let the man do?', 43);
insert into question (set_question_id, name, order_qn) values (36, 'Who most likely is Axel Schmidt?', 44);
insert into question (set_question_id, name, order_qn) values (36, 'What renovation does the woman mention?', 45);
insert into question (set_question_id, name, order_qn) values (36, 'What does the woman encourage the man to do?', 46);
insert into question (set_question_id, name, order_qn) values (37, 'What is the woman preparing for?', 47);

insert into question (set_question_id, name, order_qn) values (37, 'Why is the woman surprised?', 48);
insert into question (set_question_id, name, order_qn) values (37, 'Why does the woman say, "The slides are available on our company intranet"?', 49);
insert into question (set_question_id, name, order_qn) values (38, 'According to the woman, what will happen at the end of November?', 50);
insert into question (set_question_id, name, order_qn) values (38, 'What does the man want to know?', 51);
insert into question (set_question_id, name, order_qn) values (38, 'What does the woman say the company will pay for?', 52);
insert into question (set_question_id, name, order_qn) values (39, 'What industry do the speakers work in?', 53);
insert into question (set_question_id, name, order_qn) values (39, 'What does the woman say a project will do for a city?', 54);
insert into question (set_question_id, name, order_qn) values (39, 'What does Gerhard say needs to be done?', 55);
insert into question (set_question_id, name, order_qn) values (40, 'What does the woman imply when she says, "I dont have much to do"?', 56);
insert into question (set_question_id, name, order_qn) values (40, 'What does the man notice about some medication?', 57);
insert into question (set_question_id, name, order_qn) values (40, 'What does the man suggest doing in the future?', 58);

insert into question (set_question_id, name, order_qn) values (41, 'Who most likely is the woman?', 59);
insert into question (set_question_id, name, order_qn) values (41, 'What kind of document are the speakers discussing?', 60);
insert into question (set_question_id, name, order_qn) values (41, 'Why must the document be revised by the end of the month?', 61);
insert into question (set_question_id, name, order_qn) values (42, 'Look at the graphic. How much did the man''s company charge for its service?', 62);
insert into question (set_question_id, name, order_qn) values (42, 'Why does the man apologize?', 63);
insert into question (set_question_id, name, order_qn) values (42, 'What does the woman like about a venue?', 64);
insert into question (set_question_id, name, order_qn) values (43, 'Why is the man surprised?', 65);
insert into question (set_question_id, name, order_qn) values (43, 'Look at the graphic. In which section does the woman have seats?', 66);
insert into question (set_question_id, name, order_qn) values (43, 'What is the woman doing this weekend?', 67);
insert into question (set_question_id, name, order_qn) values (44, 'Who most likely is the man?', 68);
insert into question (set_question_id, name, order_qn) values (44, 'Look at the graphic. Which name needs to be changed?', 69);
insert into question (set_question_id, name, order_qn) values (44, 'What does the woman say she is going to do tomorrow?', 70);

-- Part 4
insert into question (set_question_id, name, order_qn) values (45, 'What kind of business is the speaker most likely calling?', 71);
insert into question (set_question_id, name, order_qn) values (45, 'What does the speaker say about her appointment?', 72);
insert into question (set_question_id, name, order_qn) values (45, 'What is the speaker interested in learning more about?', 73);
insert into question (set_question_id, name, order_qn) values (46, 'What is being advertised?', 74);
insert into question (set_question_id, name, order_qn) values (46, 'What will participants receive?', 75);
insert into question (set_question_id, name, order_qn) values (46, 'What can the listeners do on a Web site?', 76);
insert into question (set_question_id, name, order_qn) values (47, 'Where does the announcement take place?', 77);
insert into question (set_question_id, name, order_qn) values (47, 'LWhy does the speaker apologize?', 78);
insert into question (set_question_id, name, order_qn) values (47, 'What does the speaker offer the listeners?', 79);
insert into question (set_question_id, name, order_qn) values (48, 'What event is taking place?', 80);
insert into question (set_question_id, name, order_qn) values (48, 'Why does the speaker say, "And over 300 people are here"?', 81);
insert into question (set_question_id, name, order_qn) values (48, 'What does the speaker ask the listeners to do?', 82);

insert into question (set_question_id, name, order_qn) values (49, 'What is the purpose of the plan?', 83);
insert into question (set_question_id, name, order_qn) values (49, 'Who does the speaker say will receive a discount?', 84);
insert into question (set_question_id, name, order_qn) values (49, 'What will happen after three months?', 85);
insert into question (set_question_id, name, order_qn) values (50, 'What event is the speaker discussing?', 86);
insert into question (set_question_id, name, order_qn) values (50, 'Why does the speaker say, "tickets are almost sold out"?', 87);
insert into question (set_question_id, name, order_qn) values (50, 'What will happen tomorrow morning?', 88);
insert into question (set_question_id, name, order_qn) values (51, 'What type of business does the speaker work for?', 89);
insert into question (set_question_id, name, order_qn) values (51, 'What does the speaker say is an advantage of the new material?', 90);
insert into question (set_question_id, name, order_qn) values (51, 'What will the listeners do next?', 91);
insert into question (set_question_id, name, order_qn) values (52, 'Which department does the speaker work in?', 92);
insert into question (set_question_id, name, order_qn) values (52, 'Why does the speaker say, "there is a need for a skilled software engineer"?', 93);
insert into question (set_question_id, name, order_qn) values (52, 'What does the speaker want to discuss with the listener?', 94);
insert into question (set_question_id, name, order_qn) values (53, 'Why are guests invited on the speakers radio show?', 95);
insert into question (set_question_id, name, order_qn) values (53, 'What can the listeners do on a Web site?', 96);
insert into question (set_question_id, name, order_qn) values (53, 'Look at the graphic. Which day is this episode being aired?', 97);
insert into question (set_question_id, name, order_qn) values (54, 'Look at the graphic. Where will the scarves and ties be displayed?', 98);
insert into question (set_question_id, name, order_qn) values (54, 'What should be displayed near the cash registers?', 99);
insert into question (set_question_id, name, order_qn) values (54, 'What should the listener expect to receive in an e-mail?', 100);

-- Part 5
insert into question (set_question_id, name, order_qn) values (55, 'Mougey Fine Gifts is known for its large range of _____ goods.', 101);
insert into question (set_question_id, name, order_qn) values (56, 'Income levels are rising in the _____ and surrounding areas.', 102);
insert into question (set_question_id, name, order_qn) values (57, 'Since we had a recent rate change, expect _____ next electricity bill to be slightly lower.', 103);
insert into question (set_question_id, name, order_qn) values (58, 'Hotel guests have a lovely view of the ocean _____ the south-facing windows.', 104);
insert into question (set_question_id, name, order_qn) values (59, 'Mr. Kim would like _____ a meeting about the Jasper account as soon as possible.', 105);
insert into question (set_question_id, name, order_qn) values (60, 'The factory is _____ located near the train station.', 106);
insert into question (set_question_id, name, order_qn) values (61, 'Because of transportation _____ due to winter weather, some conference participants may arrive late.', 107);
insert into question (set_question_id, name, order_qn) values (62, 'Proper maintenance of your heating equipment ensures that small issues can be fixed _____ they become big ones.', 108);
insert into question (set_question_id, name, order_qn) values (63, 'The information on the Web site of Croyell Decorators is _____ organized.', 109);
insert into question (set_question_id, name, order_qn) values (64, 'The Copley Corporation is frequently _____ as a company that employs workers from all over the world.', 110);
insert into question (set_question_id, name, order_qn) values (65, 'Payments made _____ 4:00 P.M. will be processed on the following business day.', 111);
insert into question (set_question_id, name, order_qn) values (66, 'Greenfiddle Water Treatment hires engineers who have _____ mathematics skills.', 112);
insert into question (set_question_id, name, order_qn) values (67, 'After _____ the neighborhood, Mr. Park decided not to move his café to Thomasville.', 113);
insert into question (set_question_id, name, order_qn) values (68, 'The average precipitation in Campos _____ the past three years has been 7 centimeters.', 114);
insert into question (set_question_id, name, order_qn) values (69, 'Improving efficiency at Perwon Manufacturing will require a _____ revision of existing processes.', 115);
insert into question (set_question_id, name, order_qn) values (70, 'Conference attendees will share accommodations _____ they submit a special request for a single room.', 116);
insert into question (set_question_id, name, order_qn) values (71, 'To receive _____, please be sure the appropriate box is checked on the magazine order form.', 117);
insert into question (set_question_id, name, order_qn) values (72, 'Donations to the Natusi Wildlife Reserve rise when consumers feel _____ about the economy.', 118);
insert into question (set_question_id, name, order_qn) values (73, 'When _____ applied, Tilda`s Restorative Cream reduces the appearance of fine lines and wrinkles.', 119);
insert into question (set_question_id, name, order_qn) values (74, 'The marketing director confirmed that the new software program would be ready to _____ by November', 120);
insert into question (set_question_id, name, order_qn) values (75, 'Satinesse Seat Covers will refund your order _____ you are not completely satisfied.', 121);
insert into question (set_question_id, name, order_qn) values (76, 'In the last five years, production at the Harris facility has almost doubled in_____.', 122);
insert into question (set_question_id, name, order_qn) values (77, 'Ms. Tsai will _____ the installation of the new workstations with the vendor.', 123);
insert into question (set_question_id, name, order_qn) values (78, 'An upgrade in software would _____ increase the productivity of our administrative staff.', 124);
insert into question (set_question_id, name, order_qn) values (79, 'The Rustic Diner`s chef does allow patrons to make menu _____.', 125);
insert into question (set_question_id, name, order_qn) values (80, 'Ms. Rodriguez noted that it is important to _____ explicit policies regarding the use of company computers.', 126);
insert into question (set_question_id, name, order_qn) values (81, '_____ Peura Insurance has located a larger office space, it will begin negotiating the rental agreement.', 127);
insert into question (set_question_id, name, order_qn) values (82, 'Mr. Tanaka`s team worked _____ for months to secure a lucrative government contract.', 128);
insert into question (set_question_id, name, order_qn) values (83, 'Though Sendak Agency`s travel insurance can be purchased over the phone, most of _____ plans are bought online.', 129);
insert into question (set_question_id, name, order_qn) values (84, 'Garstein Furniture specializes in functional products that are inexpensive _____ beautifully crafted.', 130);

-- Part 6
insert into question (set_question_id, name, order_qn) values (85, '', 131);
insert into question (set_question_id, name, order_qn) values (85, '', 132);
insert into question (set_question_id, name, order_qn) values (85, '', 133);
insert into question (set_question_id, name, order_qn) values (85, '', 134);
insert into question (set_question_id, name, order_qn) values (86, '', 135);
insert into question (set_question_id, name, order_qn) values (86, '', 136);
insert into question (set_question_id, name, order_qn) values (86, '', 137);
insert into question (set_question_id, name, order_qn) values (86, '', 138);
insert into question (set_question_id, name, order_qn) values (87, '', 139);
insert into question (set_question_id, name, order_qn) values (87, '', 140);
insert into question (set_question_id, name, order_qn) values (87, '', 141);
insert into question (set_question_id, name, order_qn) values (87, '', 142);
insert into question (set_question_id, name, order_qn) values (88, '', 143);
insert into question (set_question_id, name, order_qn) values (88, '', 144);
insert into question (set_question_id, name, order_qn) values (88, '', 145);
insert into question (set_question_id, name, order_qn) values (88, '', 146);

-- Part 7
insert into question (set_question_id, name, order_qn) values (89, 'What is the purpose of the announcement?', 147);
insert into question (set_question_id, name, order_qn) values (89, 'According to Mr. Clifford, what has the airline temporarily increased?', 148);
insert into question (set_question_id, name, order_qn) values (90, 'What are applicants for this position required to have?', 149);
insert into question (set_question_id, name, order_qn) values (90, 'What is true about the job?', 150);
insert into question (set_question_id, name, order_qn) values (91, 'What is true about the software testing?', 151);
insert into question (set_question_id, name, order_qn) values (91, 'What action was difficult for users to complete?', 152);
insert into question (set_question_id, name, order_qn) values (92, 'What is indicated about Ms. Atiyeh`s previous appearance at Mutamark?', 153);
insert into question (set_question_id, name, order_qn) values (92, 'How many people can the Koros Hall accommodate?', 154);
insert into question (set_question_id, name, order_qn) values (92, 'When will Ms. Atiyeh most likely appear at the Mutamark conference?', 155);
insert into question (set_question_id, name, order_qn) values (93, 'What kind of business most likely is Saenger, Inc.?', 156);
insert into question (set_question_id, name, order_qn) values (93, 'What is indicated about the monorail?', 157);
insert into question (set_question_id, name, order_qn) values (93, 'In which of the positions marked [1], [2], [3], and [4] does the following sentence best belong? "Along the way, the line will stop at nine stations."', 158);
insert into question (set_question_id, name, order_qn) values (94, 'At 3:01 P.M., what does Ms. McCall most likely mean when she writes, "No problem"?', 159);
insert into question (set_question_id, name, order_qn) values (94, 'What type of work does Ms. McCall most likely do?', 160);
insert into question (set_question_id, name, order_qn) values (95, 'What is suggested about the craft fair?', 161);
insert into question (set_question_id, name, order_qn) values (95, 'What is NOT mentioned as a requirement for selling at the craft fair?', 162);

insert into question (set_question_id, name, order_qn) values (95, 'What does Ms. Renaldo most likely sell?', 163);
insert into question (set_question_id, name, order_qn) values (95, 'In which of the positions marked [1], [2], [3], and [4] does the following sentence best belong? "Make sure they clearly represent the items you wish to offer for purchase at the event."', 164);
insert into question (set_question_id, name, order_qn) values (96, 'In what industry does Sleep Soundly Solutions operate?', 165);
insert into question (set_question_id, name, order_qn) values (96, 'What new product is being offered by Sleep Soundly Solutions?', 166);
insert into question (set_question_id, name, order_qn) values (96, 'The word "meet" in paragraph 3, line 3, is closest in meaning to', 167);
insert into question (set_question_id, name, order_qn) values (97, 'What is one purpose of the letter?', 168);
insert into question (set_question_id, name, order_qn) values (97, 'The word "established" in paragraph 1, line 3, is closest in meaning to', 169);
insert into question (set_question_id, name, order_qn) values (97, 'What is suggested about Dr. Geerlings?', 170);
insert into question (set_question_id, name, order_qn) values (97, 'What is NOT indicated about JATA in the letter?', 171);
insert into question (set_question_id, name, order_qn) values (98, 'For what type of company do the writers work?', 172);
insert into question (set_question_id, name, order_qn) values (98, 'At 8:59 A.M., what does Ms. Randolph most likely mean when she writes, "Not at all"?', 173);
insert into question (set_question_id, name, order_qn) values (98, 'What is indicated about Mr. Erickson?', 174);
insert into question (set_question_id, name, order_qn) values (98, 'According to the discussion, what is important to Mr. Peters about a new hire?', 175);
insert into question (set_question_id, name, order_qn) values (99, 'What is NOT recommended in the article?', 176);
insert into question (set_question_id, name, order_qn) values (99, 'Why are blinds mentioned?', 177);
insert into question (set_question_id, name, order_qn) values (99, 'What is indicated about the magazine?', 178);
insert into question (set_question_id, name, order_qn) values (99, 'What is suggested about Ms. Testa?', 179);

insert into question (set_question_id, name, order_qn) values (99, 'What is suggested about Moveable, Inc.`s products?', 180);
insert into question (set_question_id, name, order_qn) values (100, 'How does Tour 1 differ from all the other tours?', 181);
insert into question (set_question_id, name, order_qn) values (100, 'What is included in the cost of the tours?', 182);
insert into question (set_question_id, name, order_qn) values (100, 'What tour did Ms. Bouton most likely take?', 183);
insert into question (set_question_id, name, order_qn) values (100, 'What does the review suggest about Ms. Bouton?', 184);
insert into question (set_question_id, name, order_qn) values (100, 'Why was Ms. Bouton disappointed with the tour?', 185);
insert into question (set_question_id, name, order_qn) values (101, 'What most likely is the topic of the seminar on June 11 ?', 186);
insert into question (set_question_id, name, order_qn) values (101, 'What iS suggested about Mr. Morgan?', 187);
insert into question (set_question_id, name, order_qn) values (101, 'What is the purpose of the notice?', 188);
insert into question (set_question_id, name, order_qn) values (101, 'According to the second e-mail, what does Mr. Morgan suggest changing?', 189);
insert into question (set_question_id, name, order_qn) values (101, 'How much did Mr. Morgan spend on the book he showed to Ms. Tsu?', 190);
insert into question (set_question_id, name, order_qn) values (102, 'What is the purpose of the article?', 191);
insert into question (set_question_id, name, order_qn) values (102, 'What positive aspect of the Anton Building does Ms. Yadav mention?', 192);
insert into question (set_question_id, name, order_qn) values (102, 'What is suggested about JPD in Ms. Bautista`s e-mail?', 193);
insert into question (set_question_id, name, order_qn) values (102, 'What information about the building does Ms. Bautista request from Mr. Rowell?', 194);
insert into question (set_question_id, name, order_qn) values (102, 'What space would Lenoiva most likely choose to rent?', 195);
insert into question (set_question_id, name, order_qn) values (103, 'What does Ms. Jefferson mention in the first e-mail?', 196);
insert into question (set_question_id, name, order_qn) values (103, 'What rental option best meets Ms. Jefferson`s needs?', 197);
insert into question (set_question_id, name, order_qn) values (103, 'What is the hourly rate of DGC`s newest rental option?', 198);
insert into question (set_question_id, name, order_qn) values (103, 'What is indicated about DGC in the price list?', 199);
insert into question (set_question_id, name, order_qn) values (103, 'According to the price list, what is true about all boats?', 200);
